...
// Fixed card width for the menu grid — cards never grow, the grid just
// adds more columns via auto-fill as the container gets wider.
...
export default function POS() {
  ...
  // Add-new-customer form state (inside checkout modal)
